...
lis_order_item_mysql = Blueprint('lis_order_item_mysql', __name__)

@lis_order_item_mysql.route("/orderItem/retrieveOrderItemMySQL", methods=['POST'])
def retrieveOrderItemMySQL():
    try:
