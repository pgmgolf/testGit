...
nav_group_object_mysql = Blueprint('nav_group_object_mysql', __name__)

@nav_group_object_mysql.route("/navigation/retrieveGroupObjectMySQL", methods=['POST'])
def retrieveGroupObjectMySQL():
...
@nav_group_object_mysql.route("/navigation/addGroupObjectMySQL", methods=['POST'])
def addGroupObjectMySQL():
    now = datetime.datetime.now()
    isSuccess = True
    reasonCode = 200
    reasonText = ""
...
@nav_group_object_mysql.route("/navigation/deleteGroupObjectMySQL", methods=['POST'])
def deleteGroupObjectMySQL():
    now = datetime.datetime.now()
    isSuccess = True
    reasonCode = 200
    reasonText = ""
...
@nav_group_object_mysql.route("/navigation/updateGroupObjectMySQL", methods=['POST'])
def updateGroupObjectMySQL():
    now = datetime.datetime.now()
    isSuccess = True
    reasonCode = 200
    reasonText = ""
