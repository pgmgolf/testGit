...
nav_user_object_mssql = Blueprint('nav_user_object_mssql', __name__)

@nav_user_object_mssql.route("/navigation/retrieveUserObjectMSSQL", methods=['POST'])
def retrieveUserObjectMSSQL():
    try:
        ...
        pl_user_object.user_skey,pl_user_object.access_ind,pc_user_def.user_id,pc_user_def.first_name + ' ' + pc_user_def.first_name as full_name
...
@nav_user_object_mssql.route("/navigation/addUserObjectMSSQL", methods=['POST'])
def addUserObjectMSSQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
...
@nav_user_object_mssql.route("/navigation/deleteUserObjectMSSQL", methods=['POST'])
def deleteUserObjectMSSQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
...
@nav_user_object_mssql.route("/navigation/updateUserObjectMSSQL", methods=['POST'])
def updateUserObjectMSSQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
