...
visit_mssql = Blueprint('visit_mssql', __name__)

@visit_mssql.route("/visit/addVisitMySQL", methods=['POST'])
def addVisitMySQL():
    ...
    visit_skey = getNextSequenceMSSQL('lis_visit','lis_visit','visit_skey')
    visit_id = getNextSequenceMSSQL('lis_visit','',aryear,armonth,arday,'0000','00','00','00','Y','Y','Y','','','-')
...
@visit_mssql.route("/visit/addEpisodeMySQL", methods=['POST'])
def addEpisodeMySQL():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
    ...
    ep_skey = getNextSequenceMSSQL('episode','episode','ep_skey')
...
@visit_mssql.route("/visit/updateVisitMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/updateEpisodeMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/addVisitAndEpisodeMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/getPhysicianMySQL", methods=['POST'])
def getPhysician ():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
...
@visit_mssql.route("/visit/getPhysicianAppointmentMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/getTimeSlotMySQL", methods=['POST'])
def getTimeSlot ():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
...
@visit_mssql.route("/visit/getTimeSlotFromTimeMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/getClinicMySQL", methods=['POST'])
def getClinic ():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
...
@visit_mssql.route("/visit/getPriorityMySQL", methods=['POST'])
def getPriority ():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
...
@visit_mssql.route("/visit/retrieveEpisodeMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/retrieveVisitMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/updateEpStatusMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/retrieveVisitAppointmentMySQL", methods=['POST'])
...
@visit_mssql.route("/visit/getCountVisitMSSQL", methods=['POST'])
def getCountVisit ():
    returnUserToken = getUserToken(request.headers.get('Authorization'))
    if not returnUserToken["isSuccess"]:
        return jsonify(returnUserToken);
...
@visit_mssql.route("/visit/getStatVisitPhysicianMSSQL", methods=['POST'])
...
@visit_mssql.route("/visit/getStatVisitPhysicianMonthMSSQL", methods=['POST'])
...
# select 'Aug' as month, 280 as 'visit qty', 232 as qty
    ...
    sql = """\
   select top 100 convert(nvarchar,a.date_arrived,112) as month, count(1) as [Visit QTY],100 as qty
    from lis_visit a
    group by convert(nvarchar,a.date_arrived,112)
    order by convert(nvarchar,a.date_arrived,112) desc
    """
   # sql = """\
