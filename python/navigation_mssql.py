...
navigation_mssql = Blueprint('navigation_mssql', __name__)

@navigation_mssql.route("/navigation/retrieveComponentMySQL", methods=['POST'])
...
@navigation_mssql.route("/navigation/addComponentMySQL", methods=['POST'])
...
@navigation_mssql.route("/navigation/updateComponentMySQL", methods=['POST'])
...
@navigation_mssql.route("/navigation/deleteComponentMySQL", methods=['POST'])
