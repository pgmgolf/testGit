...
nav_node_language_mysql = Blueprint('nav_node_language_mysql', __name__)

@nav_node_language_mysql.route("/navigation/retrieveLanguageMySQL", methods=['POST'])
def retrieveLanguageMySQL():
    try:
...
@nav_node_language_mysql.route("/navigation/addNodeLanguageMySQL", methods=['POST'])
def addNodeLanguageMySQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
...
@nav_node_language_mysql.route("/navigation/updateNodeLanguageMySQL", methods=['POST'])
def updateNodeLanguageMySQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
...
@nav_node_language_mysql.route("/navigation/deleteNodeLanguageMySQL", methods=['POST'])
def deleteNodeLanguageMySQL():
    try:
        now = datetime.datetime.now()
        isSuccess = True
        reasonCode = 200
